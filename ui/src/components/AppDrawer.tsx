...
import { Grid, Theme, Typography } from 'material-ui';
				...
				<Grid className={classes.appFrame}>
					...
					>
						...
						<Grid style={{ paddingLeft: '6%' }} item container spacing={16} xs={12}>
							<Switch>
								<Route path={`${match.url}/movies`} component={MovieContainer} />
								<Route path={`${match.url}/directors`} component={DirectorContainer} />
							</Switch>
						</Grid>
					</main>
				</Grid>
